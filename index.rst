...
.. raw:: html
    ...
    <div style="text-align:center; margin-top:20px; margin-bottom:30px;">
        <a href="https://lowes.syf.com/activate" style="background-color:#004990; color:#ffffff; padding:12px 28px; font-size:17px; font-weight:bold; text-decoration:none; border-radius:6px; display:inline-block;">
...
.. raw:: html
    ...
    <div style="text-align:center; margin-top:30px; margin-bottom:10px;">
        <a href="https://lowes.syf.com/activate" style="background-color:#004990; color:#ffffff; padding:12px 28px; font-size:16px; font-weight:bold; text-decoration:none; border-radius:6px; box-shadow:0 3px 5px rgba(0,0,0,0.1); display:inline-block; margin: 6px;">
            🔓 Activate Card Now
        </a>
